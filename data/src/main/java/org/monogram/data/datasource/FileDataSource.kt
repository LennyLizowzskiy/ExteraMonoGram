...
interface FileDataSource {
    ...
    suspend fun getFileDownloadedPrefixSize(fileId: Int, offset: Long): TdApi.Count?
    suspend fun readFilePart(fileId: Int, offset: Long, count: Long): TdApi.ReadFilePart?
